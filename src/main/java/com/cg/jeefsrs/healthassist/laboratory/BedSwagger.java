package com.cg.jeefsrs.healthassist.laboratory;
...
public class BedSwagger {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Bed Service").description("Bed Service Module For Health Assit").contact("C Sumanth").version("1.0").build();	
	}
}